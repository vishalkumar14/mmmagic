...
module.exports = {
  ...
  MAGIC_NO_CHECK_CSV: 0x080000, /* Don't check for CSV files */
  MAGIC_NO_CHECK_TOKENS: 0x100000, /* Don't check tokens */
  MAGIC_NO_CHECK_ENCODING: 0x200000, /* Don't check text encodings */
  MAGIC_NO_CHECK_JSON: 0x400000, /* Don't check for JSON files */
  MAGIC_NO_CHECK_SIMH: 0x800000 /* Don't check for SIMH tape files */
};
